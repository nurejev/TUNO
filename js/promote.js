  ...
  items: [
    ...
    },
    {
      ...
      test: [
        ...
        "10436: click the gaps chip on a real bundle — the table must show ONLY the gaps, all of them even past 50 rows; Clear must drop the evidence and keep the policy; Start over must land on the upload state and clear the loop's manual marks.",
      ],
