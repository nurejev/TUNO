  ...
  items: [
    {
      ...
      tools: ["T01 AppLocker builder & validator"], builds: [10617, 10618], risk: "medium",
      ...
      test: [
        "10618 (devcf, 18 Sep): the site read and the listing worked first time, Import did not — the item read is now plain, without a $select naming the annotation. Re-test: Import newest events bundle lands the bundle on the table.",
