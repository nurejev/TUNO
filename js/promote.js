  ...
  items: [
    {
      ...
      tools: ["T22", "T11", "T02"],
      builds: [10506, 10507, 10508, 10509],
      ...
      test: [
        ...
        "Press the permissions button on an account that CANNOT consent: it must offer the admin-consent link rather than a bare failure, and it must not leave the card claiming anything was granted.",
