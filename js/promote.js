  ...
  items: [
    {
      ...
      tools: ["T01 AppLocker builder & validator"], builds: [10617, 10618, 10619], risk: "medium",
      ...
      test: [
        "10618/10619 (devcf, 18 Sep): the site read and the listing worked first time; Import failed twice — no download URL from a $select naming the annotation (10618), then Failed to fetch on the pre-authenticated URL because SharePoint's download host answers no CORS (10619). The bytes now come through a Graph $batch of the /content request, base64 body. Re-test: Import newest events bundle lands the bundle on the table; if it still fails the card says which of the two routes refused.",
