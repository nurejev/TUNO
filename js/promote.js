...
const PROMOTE = {
  ...
  items: [
    ...
    },
    {
      ...
      tools: ["T01 AppLocker"], builds: [10553, 10555, 10557, 10560, 10562, 10563], risk: "medium",
      ...
      test: [
        ...
        "Encrypted values (10563): on a tenant whose custom profiles were saved after Intune began encrypting OMA-URI values, Compare and the events card's pull-from-the-tenant read the rules (one getOmaSettingPlainTextValue call per collection) instead of 'no readable RuleCollection values'; with the config scope unconsented the message names Graph's refusal.",
      ...
      files: ["scripts/Invoke-TunoAppLockerScan.ps1", "js/applocker.js", "js/graph.js", "js/msappcatalog.js", "index.html", "scripts/README.md", "scripts/REVIEW-AaronLocker.md", "js/version.js", "js/changelog.js", "js/promote.js"],
    },
    {
